...
<head>
    ...
    <meta name="description" content="<?php echo e(__('landings.meta_description')); ?>">
    <meta name="keywords" content="<?php echo e(__('landings.meta_keywords')); ?>">
    <title><?php echo e(__('landings.hotels_title')); ?> - Costa Rica Trip Packages</title>
    ...
    <!-- SEO: Hreflang -->
    <link rel="alternate" hreflang="es" href="<?php echo e(route('landing.hotels.es')); ?>" />
    <link rel="alternate" hreflang="en" href="<?php echo e(route('landing.hotels.en')); ?>" />
</head>
<body>
    <!-- Navigation -->
    <nav>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1><?php echo e(__('landings.hotels_title')); ?></h1>
            <p><?php echo e(__('landings.hotels_description')); ?></p>
            <a href="#hotels" class="cta-button"><?php echo e(__('landings.book_now')); ?></a>
        </div>
    </section>

    <!-- Featured Hotels -->
    <section id="hotels" class="container">
        <h2 class="section-title">✨ <?php echo e(__('landings.adventure_title')); ?></h2>
        <p class="section-subtitle"><?php echo e(__('landings.adventure_description')); ?></p>
            ...
            <div class="hotel-card">
                ...
                <div class="hotel-content">
                    ...
                    <div class="hotel-price">
                        <div>
                            <div class="price-label"><?php echo e(__('landings.price_from')); ?></div>
    ...
    <section class="amenities">
        <div class="container">
            <h2 class="section-title">🏨 <?php echo e(__('landings.included')); ?></h2>
...
<?php /**PATH /home/elizabeth/costaricatrippackages/resources/views/landings/hotels.blade.php ENDPATH**/ ?>