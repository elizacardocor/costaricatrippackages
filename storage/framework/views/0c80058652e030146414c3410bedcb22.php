...
<?php $__env->startSection('title', __('tours.listing_title')); ?>

<?php $__env->startSection('meta_description', __('tours.listing_meta_description')); ?>
<?php $__env->startSection('meta_keywords', 'tours Costa Rica, paquetes turísticos, aventuras, volcanes, selva tropical'); ?>

<?php $__env->startSection('og_title', __('tours.listing_og_title', ['default' => __('tours.listing_title')])); ?>
<?php $__env->startSection('og_description', __('tours.listing_og_description', ['default' => __('tours.listing_meta_description')])); ?>
<?php $__env->startSection('og_image', asset('images/og-tours.jpg')); ?>

<?php $__env->startSection('twitter_title', __('tours.listing_og_title', ['default' => __('tours.listing_title')])); ?>
<?php $__env->startSection('twitter_description', __('tours.listing_og_description', ['default' => __('tours.listing_meta_description')])); ?>
<?php $__env->startSection('twitter_image', asset('images/og-tours.jpg')); ?>
...
<div class="content-box">
    ...
    <div class="page-header">
        <img src="<?php echo e(asset('images/parqManuelAntonio/playa-parque-nacional-manuel-antonio.jpg')); ?>" alt="Costa Rica Tours" class="page-header-image" loading="eager" fetchpriority="high">
...
<div class="filters-section">
    <!--<div class="container">
        <h1><?php echo e(__('tours.listing_title')); ?></h1>
        <p class="subtitle"><?php echo e(__('tours.listing_subtitle')); ?></p>
        <div class="filters">
...
<section style="background: linear-gradient(135deg, #FF6B35 0%, #FF9500 100%); color: white; padding: 5rem 2rem; text-align: center; margin-top: 3rem; box-shadow: 0 10px 30px rgba(0,0,0,0.2);">
    <div class="container">
        <h2 style="font-size: 3rem; font-weight: 700; margin-bottom: 1.5rem; text-shadow: 2px 2px 8px rgba(0,0,0,0.3);">
            <?php echo e(app()->getLocale() === 'es' ? '¿Eres un Operador de Tours?' : 'Are you a Tour Operator?'); ?>
        ...
        <p style="font-size: 1.3rem; line-height: 1.6; opacity: 0.95; margin-bottom: 2rem; max-width: 700px; margin-left: auto; margin-right: auto; text-shadow: 1px 1px 4px rgba(0,0,0,0.2);">
            <?php echo e(app()->getLocale() === 'es' ? '¡Registra tus tours en nuestra plataforma! Alcanza a miles de viajeros que buscan experiencias únicas en Costa Rica' : 'Register your tours on our platform! Reach thousands of travelers looking for unique experiences in Costa Rica'); ?>
        ...
        <a href="<?php echo e(app()->getLocale() === 'es' ? '/es/registrar_servicio' : '/en/register_service'); ?>" 
           style="display: inline-block; background: white; color: #FF6B35; padding: 1rem 2.5rem; border-radius: 50px; font-weight: 700; font-size: 1.1rem; text-decoration: none; transition: all 0.3s; box-shadow: 0 5px 15px rgba(0,0,0,0.2);">
            <?php echo e(app()->getLocale() === 'es' ? '➕ Registra tu Tour' : '➕ Register Your Tour'); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/c/Users/Elizabeth/costaricatrippackages/resources/views/tours/index.blade.php ENDPATH**/ ?>